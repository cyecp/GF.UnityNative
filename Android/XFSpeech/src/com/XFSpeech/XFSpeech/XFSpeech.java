...
public class XFSpeech {
	// -------------------------------------------------------------------------
		...
		// -------------------------------------------------------------------------
		public static XFSpeech Instantce(String resultreceiver,String app_id,String language) {
			if (mXFSpeech == null) {
 ...
 SpeechUtility.createUtility(mUnityActivity, SpeechConstant.APPID +"="+app_id+"," + SpeechConstant.FORCE_LOGIN +"=true");
             
             Log.e("XFSpeech", "createRecognizer");
              mspeech=SpeechRecognizer.createRecognizer(mUnityActivity, mInitListener);
		...
		//	Intent intent = new Intent(mUnityActivity, XFSpeechActivity.class);
		//	intent.putExtra("Operate", "CancelSpeech");
		...
		public static void sendToUnity(_ERESULT result, String most_possibleresult) {
			...
			Log.e("XFSpeech", "sendToUnity::result::" + result+"  most_possibleresult:: "+most_possibleresult);
